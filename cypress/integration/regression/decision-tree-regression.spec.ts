...
describe.skip('Regression test of the decision tree', () => {
  ...
  it('should search attribute based on a substring', () => {
    ...
    decisionTreesPage.decisionTreeResults.unitName
      .eq(0)
  ...
  it('should add Max_GQ attributes to the second step | step 8', () => {
    ...
    decisionTreesPage.addMinGq('10', '100')
    decisionTreesPage.attributesList.addSelectedAttributes.click()
    decisionTreesPage.decisionTreeResults.searchResults.eq(1).type('Min_GQ')
    decisionTreesPage.decisionTreeResults.stepCard
      .getChildren()
      .contains('Min_GQ')
    decisionTreesPage.decisionTreeResults.searchResults.eq(1).clear()
    ...
    decisionTreesPage.decisionTreeResults.searchResults.eq(1).type('Max_GQ')
    decisionTreesPage.decisionTreeResults.stepCard
      .getChildren()
      .contains('Max_GQ')
  })
