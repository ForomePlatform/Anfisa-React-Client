...
Scenario: 06 Clear button
	Given The "Custom_Inheritance_Mode" filter was applied (Autosomal Dominant + Not)
	When user clicks on "Clear  all" button under Results section
...
Scenario: 07 Reset button
	...
	And "Custom_Inheritance_Mode" functional attribute was displayed
	When user selects Inheritance mode value
