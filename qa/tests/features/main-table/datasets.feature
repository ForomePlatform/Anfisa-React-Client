...
Scenario:03 Save a new dataset with applied preset
	Given The main table of the dataset was opened
...
Scenario:04 Save dataset with more than 2000 variants
	Given The main table of the dataset was opened
...
Scenario:05 Save a new dataset without any applied filters
	Given The main table of the dataset was opened
...
Scenario:06 Save a new dataset with filter by Gene And preset
	Given The main table of the dataset was opened
	When user chooses any Preset with variants
...
Scenario:07 Save a new dataset with filter by Gene List And preset
	Given The main table of the dataset was opened
	When user chooses any Preset with variants
...
Scenario:08 Save a new dataset with filter by Sample And preset
	Given The main table of the dataset was opened
	When user chooses any Preset with variants
